...
const workoutTypeMap = {
  ...
  'strengthTraining': { type: 'Strength Training', subtype: 'Weightlifting', strengthType: 'Weightlifting', icon: '🏋️' },
  ...
  'basketball': { type: 'Basketball', icon: '🏀' },
  'soccer': { type: 'Soccer', icon: '⚽' },
  'americanFootball': { type: 'Football', icon: '🏈' },
  'baseball': { type: 'Baseball', icon: '⚾' },
  'golf': { type: 'Golf', icon: '⛳' },
  'badminton': { type: 'Badminton', icon: '🏸' },
  'boxing': { type: 'Boxing', icon: '🥊' },
  'martialArts': { type: 'Martial Arts', icon: '🥋' },
  ...
  // Additional sports (auto-categorized as cardio, each as their own type)
  'volleyball': { type: 'Volleyball', icon: '🏐' },
  'hockey': { type: 'Hockey', icon: '🏒' },
  'lacrosse': { type: 'Lacrosse', icon: '🥍' },
  'rugby': { type: 'Rugby', icon: '🏉' },
  'softball': { type: 'Softball', icon: '🥎' },
  'squash': { type: 'Squash', icon: '🎾' },
  'tableTennis': { type: 'Table Tennis', icon: '🏓' },
  'racquetball': { type: 'Racquetball', icon: '🎾' },
  'handball': { type: 'Handball', icon: '🤾' },
  'pickleball': { type: 'Pickleball', icon: '🏓' },
  'cricket': { type: 'Cricket', icon: '🏏' },
  'australianFootball': { type: 'Australian Football', icon: '🏈' },
  'wrestling': { type: 'Wrestling', icon: '🤼' },
  'fencing': { type: 'Fencing', icon: '🤺' },
  'curling': { type: 'Curling', icon: '🥌' },
  'bowling': { type: 'Bowling', icon: '🎳' },
  // Auto-categorized cardio (own type with specific icon, not generic Sports)
  'trackAndField': { type: 'Track & Field', icon: '🏃' },
  'jumpRope': { type: 'Jump Rope', icon: '🪢' },
  'downhillSkiing': { type: 'Downhill Skiing', icon: '⛷' },
  'crossCountrySkiing': { type: 'Cross Country Skiing', icon: '⛷' },
  'snowboarding': { type: 'Snowboarding', icon: '🏂' },
  'skatingSports': { type: 'Skating', icon: '⛸' },
  'surfingSports': { type: 'Surfing', icon: '🏄' },
  'waterPolo': { type: 'Water Polo', icon: '🤽' },
  'paddleSports': { type: 'Paddle Sports', icon: '🛶' },
  // Uncategorized types (user assigns category via icon picker)
  'kickboxing': { type: 'Kickboxing', icon: '🥊' },
  'taiChi': { type: 'Tai Chi', icon: '🧘' },
  'barre': { type: 'Barre', icon: '🩰' },
  'climbing': { type: 'Climbing', icon: '🧗' },
  'gymnastics': { type: 'Gymnastics', icon: '🤸' },
  'sailing': { type: 'Sailing', icon: '⛵' },
  'fishing': { type: 'Fishing', icon: '🎣' },
  'archery': { type: 'Archery', icon: '🏹' },
  'equestrianSports': { type: 'Equestrian', icon: '🐴' },
  'waterFitness': { type: 'Water Fitness', icon: '🏊' },
  'stepTraining': { type: 'Step Training', icon: '🪜' },
  'mixedCardio': { type: 'Mixed Cardio', icon: '❤️' },
  'fitnessGaming': { type: 'Fitness Gaming', icon: '🎮' },
  'swimBikeRun': { type: 'Triathlon', icon: '🏊' },
  'snowSports': { type: 'Snow Sports', icon: '🏔' },
  'waterSports': { type: 'Water Sports', icon: '🌊' },
  'play': { type: 'Play', icon: '🎯' },
  'hunting': { type: 'Hunting', icon: '🎯' },
